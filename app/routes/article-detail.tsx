...
export function meta({ loaderData }: Route.MetaArgs) {
  return [
    { title: loaderData ? `${loaderData.article.title} — YOUR.NAME` : "文章不存在" },
  ...
  return (
    <main id="main-content" className="article-page section-frame">
      ...
      <header className="article-header">
        ...
        <div className="article-byline"><span>{article.publishedAt}</span><span>{article.readingTime}</span><span>YOUR.NAME</span></div>
      </header>
